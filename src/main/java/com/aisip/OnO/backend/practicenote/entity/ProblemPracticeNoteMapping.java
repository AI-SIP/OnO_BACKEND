...
@Table(name = "problem_practice_note_mapping", indexes = {
        @Index(name = "idx_mapping_practice_note_id", columnList = "practice_note_id"),
        @Index(name = "idx_mapping_problem_id", columnList = "problem_id")
})
